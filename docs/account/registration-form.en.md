...
Do not tell anyone your password, not even the administrators of this **XMPP** server. You will later be able to change your password using your **XMPP** client or from the [change password page](https://my.chatrix.one/register/change_password/).
...
[Account Registration](https://my.chatrix.one/register/new/){ .md-button }
