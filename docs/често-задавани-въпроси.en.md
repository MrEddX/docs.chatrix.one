...
A sample registration email template is available in the [**Registration**](https://docs.chatrix.one/en/регистрация/#_3) tab.

* * *

## Is there a **XMPP** registration message template published?

A sample **XMPP** registration message template is available in the [**Registration**](https://docs.chatrix.one/en/регистрация/#_3) tab.
...
At the moment, registering an account, through the registration form or through the applications, is prohibited! More information can be found in the [**Registration**](https://docs.chatrix.one/en/регистрация/#_2) article.
...
Detailed information can be found in the [**Privacy**](https://docs.chatrix.one/en/поверителност/#_4) article.
...
See the [Terms](https://docs.chatrix.one/en/правила/) section and specifically the [**Reporting a violation**](https://docs.chatrix.one/en/правила/#_3) section.
...
Check in the [**Status**](https://docs.chatrix.one/en/статус/#_2) section.

* * *

## How can I contact you?

Contacts are available at the bottom of the page, as well as in the [**About Me**](https://docs.chatrix.one/en/за-мен/#_2) tab. If you are using a mobile device please check the :material-menu: menu.
