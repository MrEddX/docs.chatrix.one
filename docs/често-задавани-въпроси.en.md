...
At the moment, registering an account, through the registration form or through the applications, is prohibited! More information can be found in the [**Registration**](https://docs.chatrix.one/en/регистрация/#overview-of-the-stored-data) article.
