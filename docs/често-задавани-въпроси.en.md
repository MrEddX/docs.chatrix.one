...
!!! info "Information"
     ...
     To work with the :fontawesome-solid-magnifying-glass: search engine, you can use the following hotkeys:
...
**Chatrix.One** is a server offering communication based on the **XMPP** protocol. You can send messages, emoticons, photos, voice and video messages, location and files. Voice and video connection are also available.
...
A list of free **XMPP** servers can be found on the [Jabber.at](https://list.jabber.at/) page. You can also read more information about the **XMPP** protocol in [**Wikipedia**](https://bg.wikipedia.org/wiki/Extensible_Messaging_and_Presence_Protocol).
...
Full information about registering a **Chatrix.One** account is available in the [Registration](https://docs.chatrix.one/registration/) section.

* * *

## Is there a registration email template posted?

A sample registration email template is available in the [Registration](https://docs.chatrix.one/registration/#_3) tab.

* * *

## Is there a **XMPP** registration message template published?

A sample **XMPP** registration message template is available in the [Registration](https://docs.chatrix.one/registration/#_3) tab.
...
Detailed information about the clients available for working with **Chatrix.One** depending on the operating system you use, can be found in the section [Clients](https://docs.chatrix.one/clients/). For your convenience, the download links are also posted in the lines below.
...
## How can I tell if I'm using **OMEMO**?
...
Of course. There are rules and they are mandatory for everyone. Please familiarize yourself with them in the [Rules](https://docs.chatrix.one/rules/) section.

* * *

## Do I have to write only in Cyrillic?

You can write in any language you want, as long as you follow the [rules](https://docs.chatrix.one/rules/) for using the service.

* * *

## How many devices can I use the service on?

You have virtually no limits. Just keep in mind that adding each new device leads to a loss of trust in your correspondents. In other words, they will have to trust you again, either by "blind trust" or by scanning a [**QR**](https://bg.wikipedia.org/wiki/QR_code) code from the screen of one of your active devices.
...
Yes. You will see a message like *"Pesho is typing..."* or *"Pesho is typing..."*. Accordingly, there is also a message if writing is suspended.
...
At the moment, registering an account, through the registration form or through the applications, is prohibited! More information can be found in the [Registration](https://docs.chatrix.one/registration/#_2) article.
...
Detailed information can be found in the [Privacy](https://docs.chatrix.one/privacy/#_4) article.
...
!!! info "Information"
     ...
     One of the things that I am extremely responsible for is that personal communication remains truly personal. For more information, see the [Privacy](https://docs.chatrix.one/privacy/) section.
...
The current **XMPP** standards allow very secure messaging - you just have to use them! I always use the latest encryption methods on the server and block connection establishment through insecure channels. In order to reduce the scope for hackers, I have disabled **SSH** access as well as web-based server administration. The firewall is set as restrictive as possible. Communication is secured by **TLS** certificate from [**ZeroSSL**](https://zerossl.com/) and [**Let's Encrypt**](https://letsencrypt.org/). Key exchange is via [**Diffie-Hellman**](https://bg.wikipedia.org/wiki/Diffie-Hellman).

* * *

## How stable is the service?

My observations on **XMPP** based service since 2018. to date show that the service is extremely stable. At the moment, the system has enough [**RAM**](https://bg.wikipedia.org/wiki/Памет_с_произволен_достп) memory, so that it can accommodate several thousand active users at the same time.
...
!!! warning "Caution!"
     ...
     Main Drawback: [**Bus Factor**](https://bg.wikipedia.org/wiki/Bus_factor) = 1
...
- The [**Erlang**](https://bg.wikipedia.org/wiki/Erlang) language, in which **Ejabberd** is written, was created exactly for this kind of applications and is known for its high performance;
...
The rules for using the service are published in the [Rules](https://docs.chatrix.one/rules/) section.

* * *

## Can I report a violation of the terms of service?

See the [Rules](https://docs.chatrix.one/rules/) section and specifically the [Reporting](https://docs.chatrix.one/rules/#_3) section.
...
Information about incidents, service interruptions and upcoming preventive maintenance will be published in the [Status](https://docs.chatrix.one/status/#_4) section.

* * *

## Is technical information available for the service?

Check in the [Status](https://docs.chatrix.one/status/#_2) section.

* * *

## How can I contact you?

Contacts are available at the bottom of the page, as well as in the [About Me](https://docs.chatrix.one/about-me/#_2) tab. If you are using a mobile device please check the :material-menu: menu.